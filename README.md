MD_Parola example ( See large font in action on YouTube: https://www.youtube.com/watch?v=7nPCIMVUo5g )
...
SNTP (Simple NTP) time sync (fixed to Arizona, but you can patch that). This is why WiFiManager needs an AP to connect to.
